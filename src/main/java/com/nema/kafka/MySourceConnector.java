 ...
 */
  ...
  private MySourceConnectorConfig conf;
  ...
  public void start(Map<String, String> map) {
    conf = new MySourceConnectorConfig(config(),map);
...
//    return tstClass.class;
  ...
  @Override
  public List<Map<String, String>> taskConfigs(int i) throws  UnsupportedOperationException {
    // Define the individual task configurations that will be executed.
      ArrayList<Map<String,String>> configs = new ArrayList<>(1);
      configs.add(conf.originalsStrings());
      return configs;
